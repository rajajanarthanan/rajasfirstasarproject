...
class AsarTradingViewMobile extends StatefulWidget {
  @override
  State<AsarTradingViewMobile> createState() => _AsarTradingViewMobileState();
}

class _AsarTradingViewMobileState extends State<AsarTradingViewMobile> {
